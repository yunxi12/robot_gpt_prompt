...
if __name__ == '__main__':
    scenario_name = "shelf"
    instructions = ["Take the orange out of the fridge, And put it on the table."]
    ...
    for i, instruction in enumerate(instructions):
        aimodel.generate(instruction, is_user_feedback=False)
        ...
        while True:
            ...
            if user_feedback == 'q':
                exit()
            if user_feedback != '':
                aimodel.generate(user_feedback, is_user_feedback=True)
            else:
                break
